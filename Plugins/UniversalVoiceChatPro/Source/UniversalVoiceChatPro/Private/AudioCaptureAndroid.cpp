...
extern "C"
{
	...
	{
		UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ Java_com_epicgames_unreal_GameActivity_dataMicPayload sizee %d"), (int) readSize);
		...
		if (readSize > 0) {
			...
			//UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ Java_com_epicgames_ue4_GameActivity_dataMicPayload read jni array "));
			...
			if (_microphoneSpeakComponentToCallback != NULL && _microphoneSpeakComponentToCallback->IsValidLowLevel() && IsValidChecked(_microphoneSpeakComponentToCallback)/*!_microphoneSpeakComponentToCallback->IsPendingKill()*/) {
				...
				UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ Java_com_epicgames_ue4_GameActivity_dataMicPayload _microphoneSpeakComponentToCallback no valid"));
			}
...
bool UAudioCaptureAndroid::AndroidMicrophoneStart(UMicrophoneSpeakComponent *callbackComp,int sampleRateToUse)
{
...
#if PLATFORM_ANDROID
	UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ AndroidThunkJava_AndroidStartMicrophone %d"), sampleRateToUse);
	...
	if (!AndroidThunkJava_AndroidStartMicrophone || !JavaEnv) {
		UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ Error val AndroidThunkJava_AndroidStartMicrophone %d %d "), AndroidThunkJava_AndroidStartMicrophone == NULL, JavaEnv == NULL);
		return false;
	}
...
void UAudioCaptureAndroid::AndroidMicrophoneStop(UMicrophoneSpeakComponent *callbackComp) {
...
#if PLATFORM_ANDROID
	UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ AndroidThunkJava_AndroidStopMicrophone "));
	...
	if (!AndroidThunkJava_AndroidStopMicrophone || !JavaEnv) {
		UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ Error val AndroidThunkJava_AndroidStopMicrophone %d %d "), AndroidThunkJava_AndroidStopMicrophone == NULL, JavaEnv == NULL);
		return;
	}
...
{
#if PLATFORM_ANDROID
	UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ AndroidThunkJava_AndroidAskPermissionMicrophone "));
	...
	if (!AndroidThunkJava_AndroidAskPermissionMicrophone || !JavaEnv) {
		UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ Error val AndroidThunkJava_AndroidAskPermissionMicrophone %d %d "), AndroidThunkJava_AndroidAskPermissionMicrophone == NULL, JavaEnv == NULL);
		return;
	}
...
{
#if PLATFORM_ANDROID
	UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ AndroidThunkJava_AndroidHasPermissionMicrophone "));
	...
	if (!AndroidThunkJava_AndroidHasPermissionMicrophone || !JavaEnv) {
		UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ Error val AndroidThunkJava_AndroidHasPermissionMicrophone %d %d "), AndroidThunkJava_AndroidHasPermissionMicrophone == NULL, JavaEnv == NULL);
		return false;
	}
	...
	UE_LOG(LogVoiceChatPro, Warning, TEXT("micro c++ Error val AndroidThunkJava_AndroidHasPermissionMicrophone hasPermission %d res %d"), hasPermision, res);
	return res;
